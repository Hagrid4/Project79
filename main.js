...
function submit () {
    ...
    name_of_student_array.push(name_1,name_2,name_3,name_4);
...
function sorting() {
    document.getElementById("display_name").innerHTML = name_of_student_array.sort()
    document.getElementById("display_name").innerHTML = display;
}